...
// This extern declaration allows us to use the undocumented function ZwProtectVirtualMemory in our driver
// ZwProtectVirtualMemory can be used to change the protection of a region of memory in a specific process
// which can be useful for making memory executable or writable as needed.
...
extern NTSTATUS DriverEntry(PDRIVER_OBJECT pDriver, PUNICODE_STRING pRegistryPath);
extern NTSTATUS UnloadDriver(PDRIVER_OBJECT pDriver);
